...
export const dictionaries: Record<AppLanguage, AppDictionary> = {
  en: {
    ...
    recentBills: "Recent records",
    viewAllBills: "View all records",
    createBill: "Add record",
    reviewBill: "Review record",
    ...
    appLanguageNote: "Records, customer details, and notes will not be translated automatically.",
